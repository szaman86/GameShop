...
class ProductsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'date_publish' => ['type' => 'datetime', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
        ...
        '_indexes' => [
            'fk_products_genres1_idx' => ['type' => 'index', 'columns' => ['genre_id'], 'length' => []],
            'fk_products_publishers1_idx' => ['type' => 'index', 'columns' => ['publisher_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_products_publishers1' => ['type' => 'foreign', 'columns' => ['publisher_id'], 'references' => ['publishers', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
            'collation' => 'utf8_bin'
    ...
    public $records = [
        [
            ...
            'date_publish' => '2016-02-23 20:05:17',
            'price' => 1,
            'quantity' => 1,
            'genre_id' => 1,
            'publisher_id' => 1
